...
ui = tagList(
  navbarPage(
    ...
    tabPanel("Compare Forecasts",
             sidebarPanel(
               p("For testing purposes, date input is limited between 20.04.2015 and 20.04.2016"),
               tags$hr(),
               dateInput("date_compare", label="Choose starting date", value="2015-04-20",
                         min="2015-04-20", max="2016-04-20",
