...
dir.create(paste("csv/", mjd.string, sep=""))

download.file(url_finals2000a, paste("csv/", date.string, "/finals2000A.daily.csv", sep=""), method="auto", quiet=TRUE)
download.file(url_finals_daily, paste("csv/", date.string, "/finals.daily.csv", sep=""), method="auto", quiet=TRUE)
download.file(url_gpsrapid, paste("csv/", date.string, "/gpsrapid.daily.csv", sep=""), method="auto", quiet=TRUE)
